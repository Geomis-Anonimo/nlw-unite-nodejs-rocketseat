  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="px-3 w-72 py-1.5 border border-white/10 bg-transparent rounded-lg text-sm flex items-center gap-3">
        ...
        value={search}
        className=" focus:ring-0 bg-transparent flex-1 outline-none border-0 p-0 text-sm" placeholder="Buscar participante..." />
      </div>
    </div>
      ...
      <tbody>
        {attendees.map((attendee) => {
          ...
          <TableCell>
            ...
            ? <span className="text-zinc-300">Não fez check-in</span>
